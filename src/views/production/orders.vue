...
import { getOrderAll as getList, OrderPre, NewOrder, UpdateOrder, getSupplierList, getMaterTypesList } from '@/api'
    ...
    <ListPage :tableData="data" :tableColumns="columns" dialogTitle="订单" dialogWidth="40%" :editForm="editForm"
        ...
        <template #searchForm>
            ...
            <el-form-item label="产品类型">
                <el-input v-model="searchForm.type_name" placeholder="请输入产品类型"></el-input>
            </el-form-item>
            ...
            <el-row>
                <el-col :span="11">
                    ...
                    <el-form-item label="订单总数">
                        <el-input v-model="editForm.length" placeholder="请输入订单总数"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="产品类型">
                        <!-- <el-input v-model="editForm.type_name" placeholder="产品类型"></el-input> -->
                        <el-select v-model="editForm.type_name" placeholder="请选择产品类型" filterable default-first-option
                ...
                <el-col :span="11" :offset="2">
                    ...
                    <el-form-item label="产品等级">
                        <el-input v-model="editForm.type_level" placeholder="请输入产品等级"></el-input>
                    </el-form-item>
