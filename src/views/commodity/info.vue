        ...
        :editRules="editRules" :hasOperation="true" @reset="reset">
         <template #searchForm> 
            ...
            <el-form-item label="中文名">
                <el-input v-model="searchForm.value" placeholder="请输入中文名"></el-input>
            </el-form-item>   
            ...
            <el-row>
               <el-col :span="11">
                   ...
                   <el-form-item label="中文名" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.value"
                            placeholder="请输入类型中文名"></el-input>
                    </el-form-item>  
                    <el-form-item label="颜色" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.color"
                            placeholder="请输入颜色"></el-input>
                    </el-form-item> 
                    <el-form-item label="尺寸" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.size"
                            placeholder="请输入尺寸"></el-input>
                    </el-form-item> 
                    <el-form-item label="特征值" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.category"
                            placeholder="请输入特征值"></el-input>
                    </el-form-item> 
                    <el-form-item label="款型" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.type_flag"
                            placeholder="款型，1标准，2宽，3窄"></el-input>
                    </el-form-item> 
                </el-col>
                ...
                <el-form-item label="单位编号" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.serial"
                            placeholder="对应的单位编号"></el-input>
                    </el-form-item> 
                    <el-form-item label="品质" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.quantity"
                            placeholder="请输入品质"></el-input>
                    </el-form-item> 
                    <el-form-item label="销售地" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.location"
                            placeholder="请输入销售地"></el-input>
                    </el-form-item> 
                    <el-form-item label="大类" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.parent"
                            placeholder="请输入大类"></el-input>
                    </el-form-item> 
                    <el-form-item label="成本价" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.price_default"
                            placeholder="请输入成本价"></el-input>
                    </el-form-item> 
                    <el-form-item label="发售价" prop="ratio_three">
                        <el-input :controls="false" v-model="editForm.delivery"
                            placeholder="请输入发售价"></el-input>
                    </el-form-item> 
